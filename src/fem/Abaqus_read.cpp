...
//        else if (upper.find("*NSET, NSET=BIE_TOP, GENERATE")==static_cast<std::string::size_type>(0))
//        {
//            std::string nset_name = s ;
//            //std::cout<<s <<std::endl;
//            //std::vector<int> fault_nodes;
...
//                        // 'cell' is now a string with an integer id in it
//                        // add -1 here becasue we are using a zero node numbering zero is the first node
//                        BIE_top_temp.push_back(id);
//                    }
//                }
//                std::vector<int> BIE_top_copy(BIE_top_temp[1]-BIE_top_temp[0]+1);
//                std::iota(std::begin(BIE_top_copy),std::end(BIE_top_copy),BIE_top_temp[0]-1);
//                BIE_top= BIE_top_copy;
//
//            }
//        }
//        else if (upper.find("*NSET, NSET=BIE_BOT, GENERATE")==static_cast<std::string::size_type>(0))
//        {
//            std::string nset_name = s ;
//            //std::cout<<s <<std::endl;
//            //std::vector<int> fault_nodes;
...
//                        // 'cell' is now a string with an integer id in it
//                        // add -1 here becasue we are using a zero node numbering zero is the first node
//                        BIE_bot_temp.push_back(id);
//                    }
//                }
//                std::vector<int> BIE_bot_copy(BIE_bot_temp[1]-BIE_bot_temp[0]+1);
//                std::iota(std::begin(BIE_bot_copy),std::end(BIE_bot_copy),BIE_bot_temp[0]-1);
//                BIE_bot= BIE_bot_copy;
//                
//            }
//        }
