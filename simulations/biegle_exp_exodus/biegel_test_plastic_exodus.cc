...
#include <math.h>
#include "exodusII.h"
#include "exodus_initiate_mesh.hpp"
#include "exodus_output.hpp"
...
int main() {
    ...
    std::string filename = "damage_SCEC_25m_40km_dense_384.inp";
...
//numt= 20 ;
   ...
   // time_output<<dt<<"\n";
    // Main time loop
    // Adding Exodus output
    //  Intiated Exodus output file
    int exoid, error;
    ...
    exodus_intiate_mesh(exoid, Node,Element,Ndofn);
...
//                }
       ...
       // Central Difference Time integration
        ...
        if (j%10==1)
        exodus_output(exoid, n_nodes, CPU_word_size, v_n, j, time(j));
