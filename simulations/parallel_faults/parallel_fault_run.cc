...
//    int num_faults = fault_pos.rows();
    ...
    mesh_Generated_multi_faults(x_min,x_max,y_min,y_max,dx,dy,nx_el,ny,Node, Element,BIE_top_surf_nodes, BIE_bot_surf_nodes,fault_pos, fault_nodes);
     ...
     //   std::ofstream num_fault("results/Element.txt");
    
//    std::ofstream Element_out("results/Element.txt");
//    std::ofstream Node_out("results/Node.txt");
//
//    Element_out<<Element;
//    Node_out<<Node;
//    
//    ofstream file("results/Element_out.bin",ios::binary);
//    file.write((char*)Element.data(),Element.size()*sizeof(int));
//    file.close();
//    
//    file.open("results/Node_out.bin",ios::binary);
...
//    file.close();
    ...
    // Output
//    ofstream file("results/slip_main.bin",ios::binary);
//    file.close();
//    file.open("results/slip_rate_main.bin",ios::binary);
//    file.close();
//    file.open("results/shear_main.bin",ios::binary);
//    file.close();
    ofstream file;
