...
//    int num_faults = fault_pos.rows();
    ...
    std::cout<<"fault_nodes(0)[0]= "<<fault_nodes[5][0]<<std::endl;
    std::cout<<"fault_nodes(0)[end]="<<fault_nodes[5].back()<<std::endl;
    std::cout<<"fault_nodes(0)size=" << fault_nodes[5].size()<<std::endl;
