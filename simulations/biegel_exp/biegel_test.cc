...
double time_bie;
int main() {
    //std::string filename = "default_25m_30km.inp";
 //   std::string filename = "default_25m_30km.inp";
    std::string filename = "default_12_5m.inp";
  ...
  //  VectorXi BIE_top_surf_index = VectorXi::Zero(Ndofn*(BIE_top_surf_nodes.size()),1);
   ...
   // file.write((char*)(u_n.data()),u_n.size()*sizeof(double));
    ...
    for (int j=0;j<numt;j++)
    {
     ...
     //   v_n(Fault_surf_index[0](Ndofn*(fault_nodes[0][0])))=0.0;
//        u_n(Fault_surf_index[0](Ndofn*(fault_nodes[0][1])))=0.0;
//        v_n(Fault_surf_index[0](Ndofn*(fault_nodes[0][0])))=0.0;
//        v_n(Fault_surf_index[0](Ndofn*(fault_nodes[0][1])))=0.0;
   ...
   //     std::cout<<delt_v_n[0].size()<<std::endl;
    //    std::cout<<nx_faults[0]<<std::endl;
