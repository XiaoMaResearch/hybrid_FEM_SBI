...
double time_bie;
int main() {
   // std::string filename = "test_10km_13faults.inp";
   // std::string filename = "test_10km_26faults_sym_25m.inp";
   //std::string filename = "test_python.inp";
   std::string filename = "test_python_homo.inp";

  //  std::string filename = "test_10km_26faults_sym_25m_homo.inp";
   ...
   // std::cout<<x<<std::endl;
    ...
    {
        if ((x_main(i)<=(0.0+0.6e3))&&(x_main(i)>=(0.0-0.6e3)))
        {
            T_0[0](2*i) = 27.5e6;
        }
//        else
